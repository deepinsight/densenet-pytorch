...
parser = argparse.ArgumentParser(description='PyTorch ImageNet DenseNet Training')
...
parser.add_argument('--structure', default='densenet', type=str, 
                    help='Structure:DenseNet, ')

parser.add_argument('--gpus', default='0', type=str, 
                    help='Using GPUs: Default 0. Specify 0,1,2,3 to use first 4 gpus.')

parser.add_argument('--resume', default='', type=str,
                    help='path to latest checkpoint (default: none)')

# Training Hypers And Logging
...
parser.add_argument('--growth', default=40, type=int,
                    help='number of new channels per layer (default: 40)')
...
def adjust_learning_rate(optimizer, epoch):
    ...
    lr = args.lr * (0.1 ** (epoch > 50)) * (0.1 ** (epoch > 75)) * (0.1 ** (epoch > 100))
    # log to TensorBoard
    #if args.tensorboard:
